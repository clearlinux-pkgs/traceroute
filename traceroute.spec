...
Version  : 2.1.5
Release  : 18
URL      : https://sourceforge.net/projects/traceroute/files/traceroute/traceroute-2.1.5/traceroute-2.1.5.tar.gz
Source0  : https://sourceforge.net/projects/traceroute/files/traceroute/traceroute-2.1.5/traceroute-2.1.5.tar.gz
...
%prep
%setup -q -n traceroute-2.1.5
cd %{_builddir}/traceroute-2.1.5
%patch -P 1 -p1
pushd ..
cp -a traceroute-2.1.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703119092
